...
d_su1=7;
d_su2=15;
d_se1 = 10;      % Distance from RIS to E1
...
for a_index = 1:length(a1_values)
    ...
    for jj = 1:iterations
         ...
         for ii = 1:length(snr_dB)
             ...
             Pt = 0.95 * Ps;              % Power for users
             Pj = 0.05* Ps;              % Power for jamming
...
plot(snr_dB, C_RIS1_nojam1, '-ms', 'DisplayName', 'user 1 sr nojamming in non collabrative case', 'LineWidth', 2.2, 'Color', 'g');
plot(snr_dB, C_RIS1_unknownjam1, '-m^', 'DisplayName', 'user 1 sr unknownjamming in non collabrative case', 'LineWidth', 2.2, 'Color', 'g');
plot(snr_dB, C_RIS1_knownjam1, '-mx', 'DisplayName', 'user 1 sr knownjamming in non collabrative case', 'LineWidth', 2.2, 'Color', 'g');


plot(snr_dB, aC_RIS1_nojam1, '-ms', 'DisplayName', 'user 1 sr nojamming in collabrative case', 'LineWidth', 2.2, 'Color', 'r');
plot(snr_dB, aC_RIS1_unknownjam1, '-m^', 'DisplayName', 'user 1 sr unknownjamming in collabrative case', 'LineWidth', 2.2, 'Color', 'r');
plot(snr_dB, aC_RIS1_knownjam1, '-mx', 'DisplayName', 'user 1 sr knownjamming in collabrative case', 'LineWidth', 2.2, 'Color', 'r');

xlabel('SNR (dB)', 'FontWeight', 'bold');
ylabel('Secrecy Rate (bits/sec/Hz)', 'FontWeight', 'bold');
title('secrecy rate vs snr at user 1 in both collabrative and non collabrative cases')
grid on;
