...
a1_values = 0.24;
bet=0.001;
beta = 0.005; % Imperfect SIC factor
...
plot(snr_dB, C_RIS1_nojam1, '-^', 'DisplayName', 'near user - No Jamming imperfect SIC factor 0.05 collabrative case', 'LineWidth', 2, 'Color', 'g');
plot(snr_dB, C_RIS1_unknownjam1, '-o', 'DisplayName', 'near user - Unknown Jamming imperfect SIC factor 0.05 collabrative case', 'LineWidth', 2, 'Color', 'g');
plot(snr_dB, C_RIS1_knownjam1, '-s', 'DisplayName', 'near user - Known Jamming imperfect SIC factor 0.05 collabrative case', 'LineWidth', 2, 'Color', 'g');

plot(snr_dB, aC_RIS1_nojam1, '-^', 'DisplayName', 'near user - No Jamming imperfect SIC factor 0.01 collabrative case', 'LineWidth', 2, 'Color', 'r');
plot(snr_dB, aC_RIS1_unknownjam1, '-o', 'DisplayName', 'near user - Unknown Jamming imperfect SIC factor 0.01  collabrative case', 'LineWidth', 2, 'Color', 'r');
plot(snr_dB, aC_RIS1_knownjam1, '-s', 'DisplayName', 'near user - Known Jamming imperfect SIC factor 0.01  collabrative case', 'LineWidth', 2, 'Color', 'r');

xlabel('SNR (dB)', 'FontWeight', 'bold');
ylabel('Secrecy Rate (bits/sec/Hz)', 'FontWeight', 'bold');
title('Secrecy Rate vs. SNR for User 1 with Imperfect SIC in collabrative case');
