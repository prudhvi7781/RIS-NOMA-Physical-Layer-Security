...
plot(snr_dB, C_RIS1_nojam1, '-m^', 'DisplayName', 'user 1 sr nojamming', 'LineWidth', 2.2, 'Color', 'g');
plot(snr_dB, C_RIS1_unknownjam1, '-m^', 'DisplayName', 'user 1 sr unknownjamming', 'LineWidth', 2.2, 'Color', 'r');
plot(snr_dB, C_RIS1_knownjam1, '-m^', 'DisplayName', 'user 1 sr knownjamming', 'LineWidth', 2.2, 'Color', 'k');

xlabel('SNR (dB)', 'FontWeight', 'bold');
ylabel('Secrecy Rate (bits/sec/Hz)', 'FontWeight', 'bold');
title('secrecy rate vs snr at user 1 in non collabrative condition')
grid on;
